...
SKILL_PATTERNS: dict[str, list[str]] = {
    ...
    "aws":           [r"\baws\b", r"\bamazon\s+web\b", r"\blambda\b", r"\bs3\b", r"\bglue\b", r"\bredshift\b", r"\bathena\b"],
...
EXP_LEVEL_PATTERNS: list[tuple[str, list[str]]] = [
    ("entry",  [r"\bjunior\b", r"\bentry.?level\b", r"\bgraduate\b", r"\bfresher\b", r"\b0.?[–-]?\s*2\s*years?\b"]),
    ("mid",    [r"\bmid.?level\b", r"\b2.?[–-]?\s*5\s*years?\b", r"\b3\+?\s*years?\b"]),
    ("senior", [r"\bsenior\b", r"\bsr\b", r"\blead\b", r"\bprincipal\b", r"\b5\+?\s*years?\b", r"\b7\+?\s*years?\b"]),
