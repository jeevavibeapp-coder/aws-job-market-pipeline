...
import { MapPin, Clock, Bookmark, BookmarkCheck, ExternalLink, AlertTriangle, CheckCircle2, Building2, Eye } from 'lucide-react'
import { cn, formatRelativeTime, formatSalary, scoreColor, competitionLabel, sourceLabel } from '@/lib/utils'
...
export default function JobCard({ job, onBookmarkChange }: Props) {
  ...
  return (
    <>
      {detailOpen && <JobDetail job={job} onClose={() => setDetailOpen(false)} />}
      <div className="bg-white rounded-xl border border-slate-200 p-5 hover:shadow-md transition-shadow">
        ...
        <div className="flex items-center gap-2 mt-4 pt-4 border-t border-slate-100">
          <button
            ...
            className="flex items-center justify-center gap-1.5 border border-slate-300 hover:border-slate-400 text-slate-600 text-sm font-medium py-2 px-3 rounded-lg transition-colors"
          >
